...
- It is similar to addiction mechanism.
- By introducing it often and often, you will grow an temporal immunity of its
  side-effects, but in the long-term damage will be huge.
- Effectively it is a habit - a bad one.
  - You are developing habits in order to preserve energy, you can do a
    particular thing in a semiautomatic fashion, if your habit is good enough.

**** Habit

- The cue - trigger, something which starts the habit. It can be a text message,
  notification or seeing an item on a TODO list.
- The routine - this is a semiautomatic way of doing things, it can be good,
  harmless or harmful. You will move to that state, when your brain sees cue.
- The reward - every habit develops and continuous because of
  that. Procrastination is easy to develop, because of that.
- The belief - Power of the habit. If you want to change your habit, you need to
  change the underlying belief.

*** Dealing with Procrastination

- *Pomodoro Technique* - 25 minutes of focused work, 5 minute relaxation.
- *Focus on the process, not a product* - Thinking about result of the
  particular task will release a pain in your brain (*from insular
  cortex*). Instead you should focus on a process of learning (like in
  *Pomodoro*, I'll do only 25 minutes of work). It helps your internal zombies
  (*a habits*) to march mindlessly through tasks, they don't like the outcome
  and results because they're too hard for them.
- You should develop a skill which helps you overcome the negative feeling when
  you start learning. It is inevitable, so try to let it go, don't dwell on it,
  focus on the process instead.
- You should not waste your will power, because it is very resource consuming
  thing.
- The only place when you should use your will power is when you try to develop
  a new habit or rewire an existing one, you need to recognize the cue first,
  than use all of your will power to overcome that feeling and try to get into
  routine.
- Plan your quitting time as well as the work time. The same applies to the
  breaks.
- Also, you should focus on the weekly plan list, and also - writing up a list
  of tasks an evening day before. Because it may evolve during the week. And
  weekly plan should focus only on the bigger assignments.
- Eat your biggest and ugliest frog as a first thing in the morning.
- Commit to certain tasks and routines every day, it helps developing a habit.
- Gain trust in the new system, build a belief that you can make it!
- Try with new environments, change surroundings with less amount of cues and
  interruptions.

** Memory - Deeper Investigation

- You should build your long-term memory by repetition, feedback is inevitable
  to learn new things.
- Interleaving concepts between themselves will help memorize things.
- Index Cards helps recalling and testing your ability to retrieve information
  and ensure that a particular connection is made, and it is durable.
- In order to remember something deeply and recall that you should involve as
  much senses and representations as you can (e.g. *sound*, *taste*, *image*,
  *spatial* and *environmental*).
- *Hippocampus* is a key element in process called memory consolidation (whole
  process can take several years). Without that part of the brain it is
  impossible to create new memories in *cortex*. *Astrocythes* are playing
  important role in learning, providing neutrients to neurons, keeping ion
  balance and repairing injuries in brain.
- By creating meaningful groups and grouping connected topics by a meaningful
  term eases remembering and recalling that, also you can practice that learning
  method and will be easier and easier afterwards.
- There is also something called memory palace, which connects remembering and
  memorizing stuff with spatial arrangements of e.g. your flat plan.
- Building wild and creative connections helps and enhances abilities of your
  diffuse mode.

** Better Learning

- Exercise! It helps survive newly created neurons in hippocampus. Those new
  neurons appeared after learning new stuff, in a different environment (or in a
  place with many different inputs).
- Practice makes perfect, when you are prepared. When you can prepare yourself
  to learning new material, do it.
- Learning does not progress linearly! Learning take time, be patient. Sometimes
  you need to refresh or change perspective.

*** Metaphors and Models

- Creating metaphor is vital to properly understand the idea. It will ease the
  learning process, it will help create an anchor in your brain, with which you
  can recall the idea or neurological path.
- Models and metaphors should be funny, onomatopoeic, visual. Imagine yourself
  in that particular situation e.g. as an `x` variable in the graph, how fast
  and in which direction will you move as such variable? It is called *seeing
  with the mind's eye*.
- Sometimes such things can help you get out of *einstellung*. It is easier to
  break unsuccessful trials by getting out of the box.

*** Learning Styles

- Accepting theoretical explanation about certain skill, can be problematic for
  you. It may be not sufficient and you won't understand the *how* and *why*
  behind the process. From the other hand, if you will perform such activity
  many times your brain will develop not only neuro-patterns, but also
  proper understanding and familiarity with the concept.
- You are learning by making sense from information.
- Your different style of learning is unique for you. It is your the strongest
  asset when learning. It helps creating neuro-paths easier.
- By changing your thinking, you can change your life. You can motivate
  yourself, change your direction. It helps shape your brain.
- By avoiding certain mechanisms you are refusing to use certain parts of your
  brain.

*** Teamwork

- Recent research shows that there is no left / right hemisphere, but there are
  significant differences between both of them. E.g. right hemisphere helps us
  put results of our work into a bigger picture, it is a *devil's advocate*, it
  questions status quo and searches inconsistencies.
- Regarding right hemisphere, you can easily expand diffuse mode to kind of
  *team mode* when people from your study groups will question status quo. But
  you need to keep track topic and keep small-talk to minimum.

*** Tests

- Testing and questioning yourself is a powerful recall and learning technique.
- Testing checklist:
  ...
  - Did you get a reasonable night's sleep before the test?
    - *Most important one!*
- Strategy for tests:
  - Start with hard problems, but move quickly to simpler ones.
    - It is called *Hard Start - Jump to Easy* strategy. Jump out just after the
      first sign when you will be blocked or after a feeling when you will be on
      the wrong track.
    - It helps your diffuse mode to start working on harder problems in the
      background. It helps also to avoid *einstellung*.
- Checklists are used in very demanding professions like *Pilots*, *Surgeons*
  etc.

*** Chemical Side of Stress

- Knowing chemical side of stress helps avoiding it.
- Attitude is the most important thing, try switch from stressing yourself out
  to excitement.
- Way of breathing matters! Certain mechanisms of breathing are enabling
  *fight-or-flight* reaction. Try to breath with "stomach" not with the "chest".
- Face your fears! Have a plan B for everything. By this you will subside the
  fear.
- *Bad worry* vs. *Good worry* - don't waste your time on *bad* worries.
